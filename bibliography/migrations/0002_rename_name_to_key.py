...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('bibliography_reference', 'name', 'key')

    def backwards(self, orm):
        db.rename_column('bibliography_reference', 'key', 'name')

    models = {
        u'bibliography.reference': {
            'Meta': {'ordering': "('sort', '-year', 'key')", 'unique_together': "(('key',),)", 'object_name': 'Reference'},
